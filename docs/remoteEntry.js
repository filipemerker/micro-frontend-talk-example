...
var moduleMap = {
	"./SideNav": () => {
		return Promise.all([__webpack_require__.e(852), __webpack_require__.e(819), __webpack_require__.e(680)]).then(() => () => (__webpack_require__(680)));
	},
	"./Page": () => {
		return Promise.all([__webpack_require__.e(852), __webpack_require__.e(839)]).then(() => () => (__webpack_require__(839)));
	}
};
var get = (module) => {
	return (
...
/******/ 					} else {
/******/ 						if(!/^(138|150|576|819|852|965)$/.test(chunkId)) {
